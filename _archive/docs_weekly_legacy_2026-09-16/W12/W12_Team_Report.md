...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | _…_ | `src/baseline/` · `docs/weekly/W12/` |
...
- Run folder: `experiments/W12_<ten_run>/` (nếu tuần này có chạy)
