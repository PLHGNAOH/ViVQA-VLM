...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | _…_ | `src/baseline/` · `docs/weekly/W15/` |
...
## 5. Kế hoạch tuần sau (sau defense)
...
- Run folder: `experiments/W15_<ten_run>/` (nếu tuần này có chạy)
