...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | _…_ | `src/baseline/` · `docs/weekly/W14/` |
...
- Run folder: `experiments/W14_<ten_run>/` (nếu tuần này có chạy)
