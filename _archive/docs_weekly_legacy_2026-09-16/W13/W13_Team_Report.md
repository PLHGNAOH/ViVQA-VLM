...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | _…_ | `src/baseline/` · `docs/weekly/W13/` |
...
- Run folder: `experiments/W13_<ten_run>/` (nếu tuần này có chạy)
