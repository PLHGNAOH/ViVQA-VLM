...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | _…_ | `src/baseline/` · `docs/weekly/W11/` |
...
- Run folder: `experiments/W11_<ten_run>/` (nếu tuần này có chạy)
