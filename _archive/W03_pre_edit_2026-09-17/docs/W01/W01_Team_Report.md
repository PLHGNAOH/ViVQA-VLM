...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | Review 3 paper (BLIP-2, Florence-2, Qwen2.5-VL) đủ 10 câu; lập bảng so sánh 3 baseline, đề xuất Qwen2.5-VL-3B làm baseline chính | `docs/weekly/W01/SV1_Paper_Review.md`; `Literature_Matrix.md` #1–#3 |
| SV2 | Dataset / OCR | Review 3 paper (ViVQA, ViTextVQA, TextVQA/LoRRA) đủ 10 câu; bảng thống kê nhanh 2 dataset; đề xuất PaddleOCR + đối chứng VietOCR | `docs/weekly/W01/SV2_Paper_Review.md`; `Literature_Matrix.md` #4–#5 |
| SV3 | PEFT / Training | Review 4 paper (LoRA, QLoRA, VL-Adapter, LLaVA-1.5) đủ 10 câu; đề xuất recipe QLoRA, 9 ablation, 8 giả thuyết PEFT; điền 4 hàng Literature Matrix | `docs/weekly/W01/SV3_Paper_Review.md`; `Literature_Matrix.md` #6,#7,#9,#10; `Hypotheses.md` H1–H8; `Candidate_Methods.md` |
| SV4 | Evaluation / Deployment | Review 3 paper (POPE, VQAv2, Survey TPAMI) đủ 10 câu; chốt định nghĩa EM/VQA-Acc/ANLS/POPE-vi; giao thức chuẩn hoá câu trả lời tiếng Việt | `docs/weekly/W01/SV4_Paper_Review.md`; `Literature_Matrix.md` #8 |
