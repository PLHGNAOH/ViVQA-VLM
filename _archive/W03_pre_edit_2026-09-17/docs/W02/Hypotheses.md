...
> **[W3-PREP — does NOT block Week-2 100%]** Finalize for Review 1 (W3).
...
>
> TODO (W3): numbering — IDs below are **H1–H8** (plus stub H9–H11) from the weekly draft. The former `docs/W02` scaffold used **H1–H4** with different meanings (scaffold H2 = OCR; weekly H2 = 4-bit vs 16-bit). Kept weekly IDs. Do not mix tables.
...
- [ ] TODO (W3): turn remaining stubs (H9–H11) into falsifiable statements once baseline zero-shot numbers exist (W4–W5).
