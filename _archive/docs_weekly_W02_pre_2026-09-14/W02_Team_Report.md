...
|----|---------|-------------------------|--------------------------------|
| SV1 | VLM / Baseline | _…_ | `src/baseline/` · `docs/weekly/W02/` |
...
- Run folder: `experiments/W02_<ten_run>/` (nếu tuần này có chạy)
