...
>
> **W03 note (2026-09-17):** file này là self-audit **W2** — giữ nguyên DoD. RQ/H/Gap×Paper đã chốt ở `docs/W03/` + canonical literature. Path review SV3: `docs/02_references/Reading_Notes/SV3_Paper_Review.md`.

## Definition-of-Done audit

| DoD item | Status | Evidence (file path / line) |
|----------|:------:|-----------------------------|
| D1 Literature_Matrix: 10 rows, all columns present | ✅ | canonical `docs/02_references/Literature_Matrix.md` — rows **L1–L10** (`docs/W02/Literature_Matrix.md` = pointer) |
| D1: every numeric cell tagged | ✅ | Verification legend + per-cell `✅/⚠️/❌` tags; e.g. L2 `⚠️ secondary`, L3/L4 sizes `✅ source-read` |
| D1: no invented numbers | ✅ | All paper metrics are `❌ TODO` (no PDFs) except L2 LLaVA (`⚠️ secondary`, from `docs/02_references/Reading_Notes/SV3_Paper_Review.md §P4`) |
| D1: unread-paper TODO list present | ✅ | `docs/02_references/Literature_Matrix.md` → "TODO — papers still unread" (9 PDFs) |
